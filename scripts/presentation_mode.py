...
def ensure_server_running():
    ...
    vis_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "web_visualizer")
...
def run_presentation(fast_mode=False):
  ...
  Checking Web Visualizer on http://localhost:8080 ...
    ...
    if started:
        ...
        print("  ⚠️ Run 'python scripts/launch_visualizer.py' to serve the 3D map.")
